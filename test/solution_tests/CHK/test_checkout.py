...
class TestSum():
  ...
  def test_checkout_single_inputs(self):
    ...
    sku_input = "K"
    assert checkout_solution.checkout(sku_input) == 70 
    sku_input = "L"
  ...
  def test_checkout_single_item_multiple_deals(self):
    ...
    sku_input = "QQQQ"
    assert checkout_solution.checkout(sku_input) == (80 + 30)

    sku_input = "UUUUU"
    assert checkout_solution.checkout(sku_input) == (4 * 40)

    sku_input = "VVVVV"
    assert checkout_solution.checkout(sku_input) == (90 + 130)
  ...
  def test_multiple_combo_deal(self):
    sku_input = "ZZZTTTSSS"
    assert checkout_solution.checkout(sku_input) == (45 * 3)
